      ...
      <div className="hooks right-side-main">
        <section className="hook">
          ...
          <p>
            ...
            features. For example, <em>useState</em> is a Hook that lets you add
        ...
        <section className="useState">
          ...
          <div>
            <p>
              ...
              render. For example, imagine a component that displays the score
              of a basketball game. The score of the game might change over
              time, meaning that the score is dynamic. Our component will have
              to know the score, a piece of dynamic information, in order to
