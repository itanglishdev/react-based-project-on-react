...
function Home() {
    return ( 
        <div className="home right-side-main">
            ...
            <h2>For people who do not enjoy React (...yet), but want to learn it</h2>
            <section>
                <p>First and foremost, this is a beginner friendly guide and does not want to substitute the official React <a href="https://beta.reactjs.org/">official documentation</a> . It is an extrapolation of it, build by three Junior Web Developers to try and master it themselves.</p>
            ...
            <p>The speed and "reaction" to render the code.</p>
            <p>We assume the logo explains that too: multiple small parts create a big chain reaction!</p>
            <FaReact style={{width: '80px',height: '80px', marginLeft:'280px'}} /> 
        </div>
     );
}
