      ...
      <div className="react-basics  right-side-main">
        ...
        <section>
          ...
          <div className="react-basics__how-to-install">
            <p>
              {" "}
              The simplest way to create a react project is to type this in your
              terminal
            </p>
        ...
        <section className="react-basics__remove">
          ...
          <p>
            Some parts of what we have installed can be deleted, we wouldn't
        ...
        <section className="react-basics__npm">
          ...
          <p>
            Next step is to type the following code to acces your project in
            real time
          </p>
          <div className="code-section">
            <code>npm start</code>
          ...
          <p>
            'Ctrl+SHIFT+i' to access your developer tool on the web paged that
            just opened and check to solve the errors:{" "}
          </p>
          <p>
            you have deleted some files and you have to delete the connections
            to the files that are not there anymore
          </p>
        </section>
        ...
        <section className="react-basics__jsx">
          <h3>Writing JSX</h3>
          <p>
            Be prepared to write code in JSX, that is HTML with a twist and
            flavoured with JavaScript. Confusing at first, I know, but nothing
            simpler:
          </p>
          <p>
            similar semantic to HTML but by adding JavaScript context in within
