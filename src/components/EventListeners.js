      ...
      <div className="event-listener  right-side-main">
        <section className="react-event">
          ...
          <p className="reactEvent_p">
            Just like <em>HTML DOM</em> events, <em>React</em> can perform
            actions based on user events. <em>React</em> has the same events as
            HTML: <em>click</em>, <em>change</em>, <em>mouseover</em> etc.
          </p>
        </section>
