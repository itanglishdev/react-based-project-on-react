...
function FragmentsSection() {
    ...
    return ( 
        <section className="fragments">
            ...
            <p>Translation:<br/>
            they are used following the rule of returning only ONE element, but they allows to don't create anything to show in our <code>index.html</code> show</p>
            <p>The two syntaxes:<br/>
            In this one you are not allowed to add keys or any type of JS to it, but just a fragment</p>
            <div>
