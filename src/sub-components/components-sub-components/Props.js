...
function Props() {
    return ( 
        <section className="components__props">
                <h3>Props</h3>
                <p>Props (<em>properties</em>) are a way to share data through parent/child components. You could pass a single value, but you can also pass objects, functions or arrays.</p>
                ...
                <p>The values are,usually, in the parent (or grandparent, or grand grandparent and so on).</p>
