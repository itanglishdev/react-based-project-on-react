...
function UseNavigateSection() {
    return ( 
        <section className="use-navigate">
            ...
            <p>A bit like <code>Link</code> but with a different purpose: it can be used on <code>Next Page</code> or <code>Previous Page</code> buttons to go to a specific component. There are more use to this but we'll mention a non advanced use of it.</p>
